  ...
  return (
    <style>{`
      ...
      @media (min-width: 981px) {
        ...
        .report-intro { margin-bottom: 38px; }
        .report-sheet { padding-top: 26px; padding-bottom: 92px; }
        .report-sheet__title { margin: 46px 0 24px; }
        .report-copy { margin-bottom: 48px; }
        .pricing-heading { padding-bottom: 38px; }
        .pricing-main { padding-top: 28px; }
        .why-item { padding-top: 18px; padding-bottom: 20px; }
        .signoff-copy p { margin-top: 14px; }
